...
classdef simplefitter_GUI<handle
    ...
    methods
        function obj=simplefitter_GUI(varargin)  
            ...
            obj.guihandles.selectfiles=uicontrol('style','pushbutton','String','Load raw images','Position',[xpos1,top-2*vsep,xw*1.5,vsep],'FontSize',fontsize,'Callback',{@obj.selectfiles_callback,1});
%             obj.guihandles.selectfiles.TooltipString='Select image files with bead stacks. You can select several files from different locations with the file select dialog box opend';
            obj.guihandles.imagefile=uicontrol('style','edit','String','','Position',[xpos1+1.5*xw,top-2*vsep,xw*2.5,vsep],'FontSize',fontsize);
%             obj.guihandles.imagefile.TooltipString='List of image files used for calibration. To change this list, use select camera files';
            ...
            obj.guihandles.selectcoeff=uicontrol('style','pushbutton','String','Load calibration','Position',[xpos1,top-3*vsep,xw*1.5,vsep],'FontSize',fontsize,'Callback',{@obj.selectfiles_callback,2});
%             obj.guihandles.selectcoeff.TooltipString='Select image files with bead stacks. You can select several files from different locations with the file select dialog box opend';
            obj.guihandles.calfile=uicontrol('style','edit','String','','Position',[xpos1+1.5*xw,top-3*vsep,xw*2.5,vsep],'FontSize',fontsize);
%             obj.guihandles.calfile.TooltipString='List of image files used for calibration. To change this list, use select camera files';
            ...
            obj.guihandles.camtext=uicontrol('style','text','String','Acquisition parameters:','Position',[xpos1,top-5*vsep,xw*4,vsep],'FontSize',fontsize,'HorizontalAlignment',hatitle,'FontWeight','bold');
            
            ha='right';
            
            obj.guihandles.conversiont=uicontrol('style','text','String','conversion (e-/ADU)','Position',[xpos1,top-6*vsep,xw*1.5,vsep],'FontSize',fontsize,'HorizontalAlignment',ha);
            obj.guihandles.conversion=uicontrol('style','edit','String','0.1','Position',[xpos1+xw*1.5,top-6*vsep,xw*.5,vsep],'FontSize',fontsize);
...
%             obj.guihandles.dzt.TooltipString=obj.guihandles.dz.TooltipString;
            obj.guihandles.offset=uicontrol('style','text','String','offset (ADU)','Position',[xpos1+2*xw,top-6*vsep,xw*1.5,vsep],'FontSize',fontsize,'HorizontalAlignment',ha);
            obj.guihandles.offset=uicontrol('style','edit','String','100','Position',[xpos1+xw*3.5,top-6*vsep,xw*.5,vsep],'FontSize',fontsize);
            
            obj.guihandles.peaktext=uicontrol('style','text','String','Peak candidate finding:','Position',[xpos1,top-8*vsep,xw*4,vsep],'FontSize',fontsize,'HorizontalAlignment',hatitle,'FontWeight','bold');

            obj.guihandles.peakfiltert=uicontrol('style','text','String','Filter size (pixel)','Position',[xpos1,top-9*vsep,xw*1.5,vsep],'FontSize',fontsize,'HorizontalAlignment',ha);
            obj.guihandles.peakfilter=uicontrol('style','edit','String','1.2','Position',[xpos1+xw*1.5,top-9*vsep,xw*.5,vsep],'FontSize',fontsize);
...
%             obj.guihandles.dzt.TooltipString=obj.guihandles.dz.TooltipString;
            obj.guihandles.peakcutofft=uicontrol('style','text','String','cutoff (photons)','Position',[xpos1+2*xw,top-9*vsep,xw*1.5,vsep],'FontSize',fontsize,'HorizontalAlignment',ha);
            obj.guihandles.peakcutoff=uicontrol('style','edit','String','1','Position',[xpos1+xw*3.5,top-9*vsep,xw*.5,vsep],'FontSize',fontsize);
            
             obj.guihandles.fittxt=uicontrol('style','text','String','Fitting paramters:','Position',[xpos1,top-11*vsep,xw*4,vsep],'FontSize',fontsize,'HorizontalAlignment',hatitle,'FontWeight','bold');

            obj.guihandles.roifitt=uicontrol('style','text','String','ROI size (pixel)','Position',[xpos1,top-12*vsep,xw*1.5,vsep],'FontSize',fontsize,'HorizontalAlignment',ha);
            obj.guihandles.roifit=uicontrol('style','edit','String','13','Position',[xpos1+xw*1.5,top-12*vsep,xw*.5,vsep],'FontSize',fontsize);
%             obj.guihandles.dz.TooltipString=sprintf('Distance in nm between frames. By convention, these are objective positions (not corrected for refractive index mismatch). \n A spacing between 10 nm and 50 nm works well ');
%             obj.guihandles.dzt.TooltipString=obj.guihandles.dz.TooltipString;
            obj.guihandles.bidirectional=uicontrol('style','checkbox','String','2D','Position',[xpos1+2*xw,top-12*vsep,xw*1,vsep],'FontSize',fontsize,'HorizontalAlignment',ha);
            obj.guihandles.mirror=uicontrol('style','checkbox','String','mirror','Position',[xpos1+xw*3,top-12*vsep,xw*1,vsep],'FontSize',fontsize);
            ...
            obj.guihandles.outputformat=uicontrol('style','popupmenu','String',{'csv','pointcloud-loader','ViSP'},'Position',[xpos1+1.5*xw,top-14*vsep,xw*2.5,vsep],'FontSize',fontsize);
            obj.guihandles.outputformat.TooltipString='Choose output format. CSV saves all fit parameters';
            
            
            obj.guihandles.pixelsizet=uicontrol('style','text','String','pixel size (nm)','Position',[xpos1,top-16*vsep,xw*1.5,vsep],'FontSize',fontsize,'HorizontalAlignment',ha);
            obj.guihandles.pixelsize=uicontrol('style','edit','String','100','Position',[xpos1+xw*1.5,top-16*vsep,xw*.5,vsep],'FontSize',fontsize);
            
            
            obj.guihandles.preview=uicontrol('style','pushbutton','String','Preview frame:','Position',[xpos1,top-18*vsep,xw*1.5,vsep],'FontSize',fontsize, 'Callback',@obj.preview_callback);
%             obj.guihandles.dz.TooltipString=sprintf('Distance in nm between frames. By convention, these are objective positions (not corrected for refractive index mismatch). \n A spacing between 10 nm and 50 nm works well ');
%             obj.guihandles.dzt.TooltipString=obj.guihandles.dz.TooltipString;
            obj.guihandles.previewframe=uicontrol('style','edit','String','1','Position',[xpos1+1.5*xw,top-18*vsep,xw*.5,vsep],'FontSize',fontsize,'HorizontalAlignment',ha);
            obj.guihandles.localize=uicontrol('style','pushbutton','String','Localize','Position',[xpos1+2.5*xw,top-18*vsep,xw*1.5,vsep],'FontSize',fontsize, 'Callback',@obj.localize_callback,'FontWeight','bold');
